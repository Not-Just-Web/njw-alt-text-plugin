 ...
 *
 * This file contains the unit tests for the `includes/api.php` file.
 *
...
class ActivationTest extends TestCase {
	...
	public function test_enqueue_admin_block_assets_with_valid_asset_file() {
		...
		WP_Mock::userFunction( 'wp_enqueue_script' )
		->once()
		->with( 'njw-media-admin-script', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/blocks.js', $asset_file['dependencies'], $asset_file['version'], true )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4, $arg5 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-admin-script', $arg1 );
				$this->assertEquals( njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/blocks.js', $arg2 );
				$this->assertEquals( $asset_file['dependencies'], $arg3 );
				$this->assertEquals( $asset_file['version'], $arg4 );
				$this->assertEquals( true, $arg5 );
			}
		...
		WP_Mock::userFunction( 'wp_enqueue_style' )
		->once()
		->with( 'njw-media-admin-style', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/blocks.css', $asset_file['dependencies'], $asset_file['version'] )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-admin-style', $arg1 );
				$this->assertEquals( $asset_file['dependencies'], $arg3 );
				$this->assertEquals( $asset_file['version'], $arg4 );
				$this->assertEquals( njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/blocks.css', $arg2 );
			}
		);
	...
	public function test_enqueue_cms_page_asset_with_valid_asset_file() {
		...
		WP_Mock::userFunction( 'wp_enqueue_script' )
		->once()
		->with( 'njw-media-cms-script', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/cms.js', $asset_file['dependencies'], $asset_file['version'], true )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4, $arg5 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-cms-script', $arg1 );
		...
		WP_Mock::userFunction( 'wp_enqueue_style' )
		->once()
		->with( 'njw-media-cms-style', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/cms.css', $asset_file['dependencies'], $asset_file['version'] )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-cms-style', $arg1 );
				$this->assertEquals( $asset_file['dependencies'], $arg3 );
				$this->assertEquals( $asset_file['version'], $arg4 );
	...
	public function test_enqueue_option_page_asset_with_valid_asset_file() {
		...
		WP_Mock::userFunction( 'wp_enqueue_script' )
		->once()
		->with( 'njw-media-option-page-script', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/option-page.js', $asset_file['dependencies'], $asset_file['version'], true )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4, $arg5 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-option-page-script', $arg1 );
		...
		WP_Mock::userFunction( 'wp_enqueue_style' )
		->once()
		->with( 'njw-media-option-page-style', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/option-page.css', $asset_file['dependencies'], $asset_file['version'] )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-option-page-style', $arg1 );
				$this->assertEquals( $asset_file['dependencies'], $arg3 );
				$this->assertEquals( $asset_file['version'], $arg4 );
	...
	public function test_enqueue_editor_page_asset_with_valid_asset_file() {
		...
		WP_Mock::userFunction( 'wp_enqueue_script' )
		->once()
		->with( 'njw-media-editor-page-script', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/editor.js', $asset_file['dependencies'], $asset_file['version'], true )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4, $arg5 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-editor-page-script', $arg1 );
		...
		WP_Mock::userFunction( 'wp_enqueue_style' )
		->once()
		->with( 'njw-media-editor-page-style', njw_media_get_config( 'PLUGIN_DIR_URL' ) . 'dist/editor.css', $asset_file['dependencies'], $asset_file['version'] )
		->andReturnUsing(
			function ( $arg1, $arg2, $arg3, $arg4 ) use ( $asset_file ) {
				$this->assertEquals( 'njw-media-editor-page-style', $arg1 );
				$this->assertEquals( $asset_file['dependencies'], $arg3 );
				$this->assertEquals( $asset_file['version'], $arg4 );
